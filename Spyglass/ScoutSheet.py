...
def Main ():
    ...
    SERVICE_ACCOUNT_FILE = 'Spyglass/reefscape-1058-scoutsheet-41534467162c.json'
    ...
    # Read the CSV file
    df = pd.read_csv('Spyglass/Reefscape 2025 base - Sheet1.csv')  # Replace with your CSV file path
...
Vault = {}
with open('Spyglass/ScoutIn.txt', 'r') as file:
    datain = file.read()
#wvar['a1'] = ("br")
countb = 0
TeamList = []
...
def Graph ():
    ...
    for i in range (len(PureTeamList)):
        ...
        folder_path = "Spyglass/ScouterGraphs"
...
def NewSheet (passval):
    ...
    ###create separate outputs/sheets/including graphs???
        ...
        with open('Spyglass/Reefscape 2025 base - Sheet1.csv', 'w') as f:
            f.write(hold)
